...
exports.protect = catchAsync(async (req, res, next) => {
  // Getting token and check of it's thermometer
  let token;
  if (
  ...
  if (!currentUser) {
    return next(
      new AppError(
        'The user, this token belongs to, does no longer exists.',
        401
      )
    );
  }
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // Update changedPasswordAt property for the users. Has been done in userModel
